...
/*
# It has been modified, was added the ability to write to the database
# using ajax 
*/
  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype.setState = function(key, value, callback) {
        switch(this._options.storageType){
          ...
          case "cookie":
                ...
                setTimeout(function(){ 
                    callback($.cookie(full_key, value, {expires: 36500, path: '/'});); 
        ...
        switch(this._options.storageType){
          ...
          case "localStorage":
            ...
            setTimeout(function(){ 
                ...
                callback(window.localStorage.getItem(full_key));
                // this._options.afterGetState(key, value);
              },0);
            break;
          case "database":
      ...
      Tour.prototype.end = function() {
        ...
        this.setState("end", "yes", function(){ });
      ...
      Tour.prototype.ended = function() {);
        ...
        return !!this.getState("end", function(value){ return value; });
      };

      Tour.prototype.restart = function() {
        this.setState("current_step", null, function(){ });
        this.setState("end", null, function(){ });
      ...
      Tour.prototype.setCurrentStep = function(value) {
        if (value != null) {
          this._current = value;
          return this.setState("current_step", value, function(){ return value; });
        } else {
          this._current = this.getState("current_step", function(value){
            return value;
          });
